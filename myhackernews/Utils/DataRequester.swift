...
func fetchNewStories( maxNumberOfItems : Int , progressString: @escaping (String) -> Void, completion: @escaping ([Item]) -> Void ) {
...
func fetchItems( itemIds : [NSNumber], onProgress: @escaping (Int) -> Void, completion: @escaping ([Item]) -> Void ) {
...
func fetchItemByID(itemId: NSNumber, rank: Int, startedDate: NSDate, completion: @escaping ( Item ) -> Void) {
...
func getDiffTimeInString(diffInSeconds: Int) -> String {
